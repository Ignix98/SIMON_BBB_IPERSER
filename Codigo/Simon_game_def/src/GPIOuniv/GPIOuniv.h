...
public:
	//GPIO(int number);
	GPIOuniv(pinGPIO pinName_p);
	virtual int getNumber() { return number; } /**< Returns the GPIO number as an int. */
	virtual string getName() { return name; }
	virtual pinGPIO getPin() { return pin; }

	// General Input and Output Settings
	virtual int setDirection(GPIOuniv::DIRECTION);
	virtual GPIOuniv::DIRECTION getDirection();
	virtual int setValue(GPIOuniv::VALUE);
	virtual int toggleOutput();
	virtual GPIOuniv::VALUE getValue();
	...
	virtual int streamWrite(GPIOuniv::VALUE);
	...
	virtual int setEdgeType(GPIOuniv::EDGE);
	virtual GPIOuniv::EDGE getEdgeType();
	...
	virtual ~GPIOuniv();  //destructor will unexport the pin
